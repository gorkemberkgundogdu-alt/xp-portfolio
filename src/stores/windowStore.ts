...
export const INITIAL_WINDOWS: Record<WindowId, WindowState> = {
  ...
  browser: {
    id: 'browser',
    title: 'Articles - Görkem Berk Gündoğdu Makaleleri & Düşünceler',
    titleEn: 'Articles - Thoughts & Case Studies by Görkem Berk Gündoğdu',
    icon: 'globe',
    isOpen: false,
    isMinimized: false,
    isMaximized: false,
  ...
  cv: {
    id: 'cv',
    title: 'Görkem_Berk_Gündoğdu CV.pdf - Windows Resim ve Faks Görüntüleyicisi',
    titleEn: 'Görkem_Berk_Gündoğdu CV.pdf - Windows Picture and Fax Viewer',
    icon: 'pdf',
    isOpen: false,
    isMinimized: false,
    isMaximized: false,
