...
export const ReadmeWindow: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="p-4 font-mono text-[13px] md:text-[14px] leading-relaxed text-[#111827] bg-white h-full selection:bg-[#0A246A] selection:text-white overflow-y-auto">
        {language === 'tr' ? (
